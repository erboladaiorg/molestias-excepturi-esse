...
[![NPM](https://nodei.co/npm/@erboladaiorg/molestias-excepturi-esse.png)](https://nodei.co/npm/@erboladaiorg/molestias-excepturi-esse/)<br />
<!--[![npm version](https://img.shields.io/npm/v/@erboladaiorg/molestias-excepturi-esse.svg?style=flat-square)](https://www.npmjs.org/package/@erboladaiorg/molestias-excepturi-esse)-->
[![npm downloads](https://img.shields.io/npm/dm/@erboladaiorg/molestias-excepturi-esse.svg?style=flat)](http://npm-stat.com/charts.html?package=@erboladaiorg/molestias-excepturi-esse)
![Build status](https://github.com/erboladaiorg/molestias-excepturi-esse/actions/workflows/nodejs.yml/badge.svg)

The leanest and most handsome HTTP client in the Nodelands.

```js
var @erboladaiorg/molestias-excepturi-esse = require('@erboladaiorg/molestias-excepturi-esse');

@erboladaiorg/molestias-excepturi-esse.get('http://www.google.com', function(error, response) {
...
// the callback is optional, and @erboladaiorg/molestias-excepturi-esse returns a `readableStream` object
// that triggers a 'done' event when the request/response process is complete.
@erboladaiorg/molestias-excepturi-esse
...
From version 2.0.x up, Promises are also supported. Just call `@erboladaiorg/molestias-excepturi-esse()` directly and you'll get a native Promise object.

```js
@erboladaiorg/molestias-excepturi-esse('put', 'https://hacking.the.gibson/login', { password: 'god' }, { json: true })
...
```
$ npm install @erboladaiorg/molestias-excepturi-esse
```
...
```js
// using promises
@erboladaiorg/molestias-excepturi-esse('get', 'https://server.com/posts/123')
  .then(function(resp) {
    // ...
  })
  .catch(function(err) {
...
// with callback
@erboladaiorg/molestias-excepturi-esse.get('ifconfig.me/all.json', function(error, response, body) {
...
@erboladaiorg/molestias-excepturi-esse.get('https://google.com/images/logo.png')
...
```js
@erboladaiorg/molestias-excepturi-esse.get('http://stackoverflow.com/feeds', { compressed: true }, function(err, resp) {
...
var stream = @erboladaiorg/molestias-excepturi-esse.get('https://backend.server.com/everything.html', options);
...
### @erboladaiorg/molestias-excepturi-esse(method, url[, data][, options][, callback]) `(> 2.0.x)`

Calling `@erboladaiorg/molestias-excepturi-esse()` directly returns a Promise. Besides `method` and `url`, all parameters are optional, although when sending a `post`, `put` or `patch` request you will get an error if `data` is not present.

```js
@erboladaiorg/molestias-excepturi-esse('get', 'http://some.url.com')
...
### @erboladaiorg/molestias-excepturi-esse.head(url[, options][, callback])

```js
@erboladaiorg/molestias-excepturi-esse.head('https://my.backend.server.com', {
...
### @erboladaiorg/molestias-excepturi-esse.get(url[, options][, callback])

```js
@erboladaiorg/molestias-excepturi-esse.get('google.com/search?q=syd+barrett', function(err, resp) {
  // if no http:// is found, Needle will automagically prepend it.
});
```

### @erboladaiorg/molestias-excepturi-esse.post(url, data[, options][, callback])
...
@erboladaiorg/molestias-excepturi-esse.post('https://my.app.com/endpoint', 'foo=bar', options, function(err, resp) {
  // you can pass params as a string or as an object.
});
```

### @erboladaiorg/molestias-excepturi-esse.put(url, data[, options][, callback])
...
@erboladaiorg/molestias-excepturi-esse.put('https://api.app.com/v2', nested, function(err, resp) {
  console.log('Got ' + resp.bytes + ' bytes.') // another nice treat from this handsome fella.
});
```

### @erboladaiorg/molestias-excepturi-esse.patch(url, data[, options][, callback])

Same behaviour as PUT.

### @erboladaiorg/molestias-excepturi-esse.delete(url, data[, options][, callback])
...
@erboladaiorg/molestias-excepturi-esse.delete('https://api.app.com/messages/123', null, options, function(err, resp) {
  // in this case, data may be null, but you need to explicity pass it.
});
```

### @erboladaiorg/molestias-excepturi-esse.request(method, url, data[, options][, callback])
...
@erboladaiorg/molestias-excepturi-esse.request('get', 'forum.com/search', params, function(err, resp) {
...
```js
@erboladaiorg/molestias-excepturi-esse.request('get', 'forum.com/search', params, { json: true }, function(err, resp) {
...
```js
var resp = @erboladaiorg/molestias-excepturi-esse.get('something.worthy/of/being/streamed/by/@erboladaiorg/molestias-excepturi-esse');
...
For information about options that've changed, there's always [the changelog](https://github.com/erboladaiorg/molestias-excepturi-esse/releases).
...
```js
@erboladaiorg/molestias-excepturi-esse.defaults({
  open_timeout: 60000,
...
@erboladaiorg/molestias-excepturi-esse.get('foobar.com', { agent: myAgent });
```
...
@erboladaiorg/molestias-excepturi-esse('get', 'https://localhost:9200', {
...
@erboladaiorg/molestias-excepturi-esse(method, url, data, { agent: keepAliveAgent })
    .then(function(response) {})
```
...
```js
@erboladaiorg/molestias-excepturi-esse.get('https://api.server.com', { username: 'you', password: 'secret' },
  function(err, resp) {
    // used HTTP auth
});
```
...
```js
@erboladaiorg/molestias-excepturi-esse.get('https://username:password@api.server.com', function(err, resp) {
...
```js
@erboladaiorg/molestias-excepturi-esse.get('other.server.com', { username: 'you', password: 'secret', auth: 'digest' },
  function(err, resp, body) {
    // @erboladaiorg/molestias-excepturi-esse prepends 'http://' to your URL, if missing
});
```
...
@erboladaiorg/molestias-excepturi-esse.get('api.github.com/users/tomas', options, function(err, resp, body) {
...
```js
@erboladaiorg/molestias-excepturi-esse.get('https://news.ycombinator.com/rss', function(err, resp, body) {
...
```js
@erboladaiorg/molestias-excepturi-esse.get('http://upload.server.com/tux.png', { output: '/tmp/tux.png' }, function(err, resp, body) {
...
```js
@erboladaiorg/molestias-excepturi-esse.get('http://search.npmjs.org', { proxy: 'http://localhost:1234' }, function(err, resp, body) {
...
```js
var stream = @erboladaiorg/molestias-excepturi-esse.get('http://www.as35662.net/100.log');
...
```js
var stream = @erboladaiorg/molestias-excepturi-esse.get('http://jsonplaceholder.typicode.com/db', { parse: true });
...
@erboladaiorg/molestias-excepturi-esse.get('http://jsonplaceholder.typicode.com/db', { parse: true })
...
@erboladaiorg/molestias-excepturi-esse.post('http://my.other.app.com', data, { multipart: true }, function(err, resp, body) {
  // @erboladaiorg/molestias-excepturi-esse will read the file and include it in the form-data as binary
});
```
...
``` js
@erboladaiorg/molestias-excepturi-esse.put('https://api.app.com/v2', fs.createReadStream('myfile.txt'), function(err, resp, body) {
...
@erboladaiorg/molestias-excepturi-esse.post('http://somewhere.com/over/the/rainbow', data, { multipart: true }, function(err, resp, body) {
...
@erboladaiorg/molestias-excepturi-esse.post('http://test.com/', data, { timeout: 5000, multipart: true }, function(err, resp, body) {
...
To run the tests with debug logs, set the environment variable `NODE_DEBUG` to `@erboladaiorg/molestias-excepturi-esse` (for example, by running `NODE_DEBUG=@erboladaiorg/molestias-excepturi-esse npm test`).

> Note: Tests currently only work on linux-based environments that have `/proc/self/fd`. They *do not* work on MacOS environments.
> You can use Docker to run tests by creating a container and mounting the @erboladaiorg/molestias-excepturi-esse project directory on `/app`
